//********************DS MenuDriven Code Singly Linear Linked List********************//
#include<stdio.h>
#include<stdlib.h>
...
{   
    ...
    printf("Welocme to data Structure application written by Kiran Wagh\n");
    ...
    while(1)
    {
        ...
        printf("8 : Count number of nodes form linked list\n");
        printf("9 : End of Application\n");
